...
def bitwise_operation():
    img_1 = cv2.imread('C:\\Users\\JangBeomJun\\Downloads\\af5712f936167.png')
    img_1 = cv2.resize(img_1, (256, 156))
    img_2 = cv2.imread('C:\\Users\\JangBeomJun\\Desktop\\photo\\2023-05-24 155435.png')
    img_2 = cv2.resize(img_2, (512, 512))
    point = (512-140, 20)
    
    cv2.imshow('kkkkkkk',img_1)
